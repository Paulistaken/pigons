...
pub fn get_passanger_destinations_count(passangers_staying: &[Passanger]) -> HashMap<StaId, u32> {
...
pub fn update_passangers_in_bus(
    ...
    passangers_in_bus: &mut PassangersInBusTable,
) {
...
pub fn get_passangers_in_bus_amount(id_bus: &BusID, list: &PassangersInBusTable) -> u32 {
